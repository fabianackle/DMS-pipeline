# -*- coding: utf-8 -*-
"""
Created on Tue Jun 12 14:40:37 2018
...
#        else:
#            self.oldjsoncan.destroy()

    def create_Json_object(self):
        print('creating json object')
# creating a jsonf object. either from new entry or if  loading of old jsonfile is chosen from old jsonfile
        jsonfile = Json_file()
        if self.var2.get() == 1:
...
# find all inputfiles in inputfiledirectory
